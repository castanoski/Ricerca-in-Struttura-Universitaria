...
from libsRicerca.searchGeneric import AStarSearcher, visualize
from libsRicerca.searchProblem import Path
...
from libsRicerca.searchGeneric import test
if __name__ == "__main__":
    test(SearcherMPP)

import libsRicerca.searchProblem
